...
import tpv.model.dao.base.hibernate.AbstractHibernateDAO;
    ...
    */
    ...
    public T makePersistent(T entity) throws DataAccessException {
        if(entity instanceof BaseEntity) {
            ((BaseEntity)entity).setUpdated(new Date()); //TODO: Dirty checking

            if(((BaseEntity)entity).getCreated() == null) {
                ((BaseEntity)entity).setCreated(new Date());
            }
        }
